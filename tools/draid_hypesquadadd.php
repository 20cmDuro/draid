...
$(document).ready(function() {
  $('#dawae').click(function() {
    ...
    var cur = 0;
    var hypesquad_ids = ["1", "2", "3"];

    function update_status() {
    	document.getElementById("thestatuslol").innerHTML = `ADDED HYPESQUAD TO ${cur} TOKENS`;
    }
    ...
    tokens_list.forEach(function(token, index) {
      posto = $.ajax({
        ...
        type: "post",
        data: JSON.stringify({"house_id": hypesquad_ids.random()}),
        headers: {
            "Authorization": token,
...
<body>
	...
	<center>
		<h1 style="color: lime; font-size: 100px;">Hypesquad Add</h1>
		<textarea id="list" name="list" rows="10" required="" cols="100" style="max-width: 100rem; background-color: black; color: lime; font-size: 15px;" class="form-control" placeholder="TOKENS"></textarea><br><br><br>
