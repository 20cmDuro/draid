...
$(document).ready(function() {
  $('#dawae').click(function() {
    ...
    function update_status() {
    	document.getElementById("thestatuslol").innerHTML = cur + " TOKENS LOADED INTO " + invite_code;
    }

    tokens_list.forEach(function(token, index) {
      posto = $.ajax({
        url: `https://discordapp.com/api/v6/invite/${invite_code}`,
        type: "post",
        headers: {
            "Authorization": token
        }
...
<body>
	...
	<center>
		<h1 style="color: lime; font-size: 100px;">Discord Join</h1>
